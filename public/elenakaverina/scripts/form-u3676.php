...
$form = array(
	'subject' => 'Отправка Контактные данные клиента(Моб)',
	...
	'email' => array(
		'from' => 'frolenkoe@gmail.com',
		'to' => 'frolenkoe@gmail.com'
	),
	'fields' => array(
		'custom_U3682' => array(
			'order' => 1,
		...
		'custom_U3677' => array(
			'order' => 3,
			'type' => 'string',
			'label' => 'Телефон или Skype',
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Телефон или Skype\' не может быть пустым.'
			)
		)
	)
);
